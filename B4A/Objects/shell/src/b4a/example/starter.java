...
public static b4a.example.sqlactivity _sqlactivity = null;
  public Object[] GetGlobals() {
		return new Object[] {"JSONActivity",Debug.moduleToString(b4a.example.jsonactivity.class),"Main",Debug.moduleToString(b4a.example.main.class),"Service",starter.mostCurrent._service,"SQLActivity",Debug.moduleToString(b4a.example.sqlactivity.class)};
}
}