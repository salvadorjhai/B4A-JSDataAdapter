...
public class jsonactivity_subs_2 {
...
Debug.ShouldStop(32);
jsonactivity.mostCurrent._label1.runMethod(true,"setTextColor",jsonactivity.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
